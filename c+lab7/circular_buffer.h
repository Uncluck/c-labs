...
public:
    ...
    circular_buffer(int capacity): _capacity(capacity) {
        if (_capacity == 0) {
            ...
            throw Exception("Ne vernoe znachenie capacity");
        }
    }
    ...
    circular_buffer(int capacity, T object): _capacity(capacity), _size(capacity) {
        if (_capacity == 0) {
            ...
            throw Exception("Nevernoe znachenie capacity");
        }
    }
...
void push_back(T object) {
    ...
    void insert(Iterator position, T object) {
        if (position >= _begin && position < & _data[_capacity]) {
            ...
            std::cout << "Nevernaia pozicia" << std::endl;
        }
    }
    ...
    void resize(int capacity) {
        if (capacity == 0) {
            ...
            std::cout << "Nevernoe znachenie capacity" << std::endl;
        }
    }
